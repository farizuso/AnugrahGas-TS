        ...
        <>
            <footer className="relative z-10 bg-background">
                        ...
                        <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
                            <div className="mb-10 w-full">
                                ...
                                <p className="mb-7 text-base text-body-color dark:text-dark-6">
                                    fitflex fitness is a fitness place with a
                                    digital system, so come on and become a
                                    membership
                                </p>
                                <p className="flex items-center text-sm font-medium text-dark dark:text-white">
                                    ...
                                    <a href={`https://wa.me/628515899441`}>
                                        +6285-1589-9441
                                    </a>
                                </p>
                            </div>
                        ...
                        <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
                            <div className="mb-10 w-full">
                                ...
                                <p className="text-base text-body-color dark:text-dark-6">
                                    &copy; 2024 UD Anugerah gas. All rights reserved.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div>
                    ...
                    <span className="absolute right-10 top-20 z-[-1]">
                        <svg
                            width={100}
                            height={100}
                            viewBox="0 0 75 75"
...
const LinkGroup = ({ children, header }: Props) => {
    return (
        <>
